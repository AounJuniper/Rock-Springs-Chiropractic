        ...
        >
          <div className="max-w-3xl">
            ...
            <h3 className="text-3xl md:text-5xl lg:text-6xl font-bold text-brand-blue leading-tight tracking-tight font-serif">
              ...
              <span className="text-brand-teal font-normal">
            ...
            >
              <div className="relative z-10">
                ...
                <div className="pt-6 border-t border-slate-100 flex items-center justify-between">
                  <span className="text-[10px] font-black uppercase tracking-[0.2em] text-brand-blue/30 group-hover:text-brand-teal/40 transition-colors">
                    Path {service.id}
                  </span>
